G.TextFramed = function(params) {

  var textFramed = new Vizi.Object();

  var textScript = new G.TextFramedScript(params, textFramed);
...
G.TextFramedScript = function(params) {
  Vizi.Script.call(this);
  this.params = params;

}

goog.inherits(G.TextFramedScript, Vizi.Script);

G.TextFramedScript.prototype.realize = function() {
...
G.TextFramedScript.prototype.update = function() {

}

G.TextFramedScript.prototype.appear = function() {
